...
{{-- 페이지 제목 --}}
<h3 class="alert mt-3 ctg-admin" role="alert">매출 상세</h3>
...
<div class="d-flex justify-content-center gap-2 mt-3">
    <a href="{{ route('saleo.edit', $row->id) }}{{ $tmp }}" class="btn btn-sm btn-primary" style="color: #fff;">
        <i class="fas fa-edit me-1"></i>수정
    </a>

    <form action="{{ route('saleo.destroy', $row->id) }}" method="POST" 
