...
class SaleoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.saleo.index', $data);
    }
    ...
    public function create()
    {
        ...
        $data['tmp'] = $this->qstring();
        return view('admin.saleo.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $tmp = $this->qstring();
        return redirect(url('admin/saleo' . $tmp));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.saleo.show',$data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.saleo.edit', $data);
    }
